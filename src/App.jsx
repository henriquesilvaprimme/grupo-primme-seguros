  ...
  return (
    <div className="app-container">
      ...
      <Routes>
        ...
        />
        <Route path="/leads" element={<Leads leads={leads} usuarioLogado={usuarioLogado} />} />
        <Route path="/leadsfechados" element={<LeadsFechados leadsFechados={leadsFechados} atualizarDetalhesLeadFechado={atualizarDetalhesLeadFechado} />} />
        <Route path="/leadsperdidos" element={<LeadsPerdidos leadsPerdidos={leadsPerdidos} />} />
        <Route path="/buscarlead" element={<BuscarLead leads={leads} />} />
        <Route path="/criarusuario" element={<CriarUsuario usuarios={usuarios} setUsuarios={setUsuarios} />} />
        <Route path="/usuarios" element={<Usuarios usuarios={usuarios} setUsuarios={setUsuarios} />} />
